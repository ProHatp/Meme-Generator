...
Olá esse e mais um projeto feito por mim do curso da  **Trybe**. A onde foi gerado  memes  a escolha do usuário, pode upar uma imagem ou escolher uma  difinição  **pré definida** assim que o usuário escolher basta gerar um texto acima da imagem em forma de  meme  xD.

## Exemplo de uso

![Imgur](https://i.imgur.com/kkzlpzd.gif)

# Motivo

Esse projeto foi criado somente para estudos então não critique xD
